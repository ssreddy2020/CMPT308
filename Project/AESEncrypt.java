...
public class AESEncrypt {
    ...
    /**
     * 
     * This function returns the corresponding hex integer by referring the look
     * up table
     * 
     * @param inHex
    ...
    /**
     * 
     * This function generates the round keys using an encryption key.
     * In this we are copying the 1st 4*4 matrix then performing the 
     * operations based on whether the value of j is multiple of Nc 
     * or not.
     * 
     */
    ...
    /**
     * 
     * This method will insert values into the hashmap i2Map and i3Map
     * 
     */
